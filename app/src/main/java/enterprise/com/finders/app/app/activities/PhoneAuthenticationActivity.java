...
public class PhoneAuthenticationActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                // Show a message_row and update the UI
                // [START_EXCLUDE]
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (TextUtils.isEmpty(contactKey)) {
                                contactKey = mFirebaseDatabase.push().getKey();
                            }
                            Contact newUser = new Contact(contactKey, "Default", mPhoneNumberField.getText().toString());
                            mFirebaseDatabase.child(mPhoneNumberField.getText().toString()).setValue(newUser);
                            ...
                            // Sign in failed, display a message_row and update the UI
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        switch (uiState) {
            ...
            case STATE_CODE_SENT:
                ...
                //mDetailText.setText("Code is sended");
                break;
